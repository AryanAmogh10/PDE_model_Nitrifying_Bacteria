...
0..50) for one competition regime. Usage: python render_competition.py {dirichlet,neumann,robin}"""
import sys
...
REGIME = "dirichlet"  # hardcoded for this folder
...
SUB_CMAP = {"NH4": cmap_c, "NO2": cmap_c, "NO3": cmap_c, "O2": cmap_c}
...
render_grid(get_u, SPECIES, SPECIES_LABEL, SPECIES_CMAP,
            f"competition_{REGIME}_bacteria.png", "Bacterial densities (300-circle rough IC)")
render_grid(get_c, SUBSTRATES, SUB_LABEL, SUB_CMAP,
            f"competition_{REGIME}_substrates.png", "Substrate concentrations", per_row_scale=True)
