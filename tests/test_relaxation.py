...
from nitrifiers.one_dimensional.elliptic import Grid, SUBSTRATES
from nitrifiers.one_dimensional.relaxation import solve_relaxation, compare_with_elliptic
